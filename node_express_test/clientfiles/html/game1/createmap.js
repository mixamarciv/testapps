...
function createHexButton(x,y,xpos,ypos,scale){
  ...
  var text = game.add.text(hexbtn.x, hexbtn.y,'*', hexButtonTextStyle);
  window.gamedata.groupmap.add(text);
  text.setTextBounds(0, 0, window.gamedata.objSize-2, window.gamedata.objSize+2);
...
function gd_setActiveUser1(gd){
  ...
  var hexbtn = gd.bntobj;
    ...
    window.gamedata.activeuser1btn = hexbtn;
  }
